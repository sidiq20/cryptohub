        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <button 
              ...
              <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-[#00ff94] transition-all">
                <div className="w-16 h-16 bg-[#00ff94]/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                  <Wallet2 className="w-8 h-8 text-[#00ff94]" onClick={() => navigate('/waitlist')} />
                </div>
            ...
            <button 
              ...
              <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-[#00ff94] transition-all">
                <div className="w-16 h-16 bg-[#00ff94]/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                  <ShieldCheck className="w-8 h-8 text-[#00ff94]" onClick={() => navigate('/waitlist')} />
                </div>
            ...
            <button 
              ...
              <div className="p-8 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-[#00ff94] transition-all">
                <div className="w-16 h-16 bg-[#00ff94]/20 rounded-full flex items-center justify-center mb-6 mx-auto">
                  <Rocket className="w-8 h-8 text-[#00ff94]" onClick={() => navigate('/waitlist')} />
                </div>
